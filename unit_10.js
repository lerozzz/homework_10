...
let ar4 = ['a', 11, 12, 'b', 22, 'c', 33, 'd', 44];
...
let ar6 = ['Lera', 'lev', 15, 8];

function f6() {
    for (let i = 0; i < ar6.length; i++) {
        document.querySelector('.out-6').innerHTML += ar6[i] + ' ';
    }
...
function f7() {
    ...
    for (let i = 0; i < ar7.length; i++) {
        document.querySelector('.out-7').innerHTML += ar7[i] + ' ';
    }
}
...
function f8() {
    ...
    for (let i = 0; i < ar8.length; i++) {
        document.querySelector('.out-8').innerHTML += ar8[i] + ' ';
    }
...
function f11() {
    ...
    for (let i = 0; i < ar11.length; i++) {
        document.querySelector('.out-11').innerHTML += ar11[i] + ' ';
    }
}
...
function f12() {
    ...
    for (let i = 0; i < ar12.length; i++) {
        document.querySelector('.out-12').innerHTML += ar12[i] + ' ';
    }
}
...
function f14() {
    for (let i = 0; i < ar14.length; i++) {
        document.querySelector('.out-14').innerHTML += ar14[ar14.length - 1 - i] + ' ';
    }
}
...
function f16() {
    for (let i = 0; i < ar16.length; i++) {
        if (ar16[i] % 2 == 0) {
            ...
            document.querySelector('.out-16-even').innerHTML += ar16_even[ar16_even.length - 1] + ' ';
        }
        else {
            ar16_odd[ar16_odd.length] = ar16[i];
            document.querySelector('.out-16-odd').innerHTML += ar16_odd[ar16_odd.length - 1] + ' ';
        }
    }
}
